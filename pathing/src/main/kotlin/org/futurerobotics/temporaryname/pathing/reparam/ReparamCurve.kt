...
import org.futurerobotics.temporaryname.pathing.Curve
import org.futurerobotics.temporaryname.pathing.CurvePoint
...
class ReparamCurve(private val func: VectorFunction, internal val mapping: ReparamMapping) : Curve {
    ...
    override fun atLength(s: Double): CurvePoint {
