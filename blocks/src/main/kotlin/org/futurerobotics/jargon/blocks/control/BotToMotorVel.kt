 ...
 */
class BotToMotorVel(private val driveModel: DriveModel) : PipeBlock<Pose2d, Vec>() {
 ...
 * [driveModel].
 */
class BotToMotorMotion(private val driveModel: DriveModel) : MapMotionOnly<Pose2d, Vec>() {
