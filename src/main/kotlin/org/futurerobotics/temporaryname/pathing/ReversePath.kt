...
private class ReversePathPoint(point: PathPoint) : ReversePoint<PathPoint>(point), PathPoint {
 ...
 */
fun Curve.reversed(): Curve = if (this is ReverseGeneric<*, *>) this.path else ReverseCurve(this)

/**
 * Returns this Path, but traversed in the reverse direction.
 * First derivatives will be negated.
 */
fun Path.reversed(): Curve = if (this is ReversePath) this.path else ReversePath(this)
