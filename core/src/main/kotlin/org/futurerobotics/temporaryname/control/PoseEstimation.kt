 ...
 */
class GlobalPoseTracker(initialPose: Pose2d = Pose2d.ZERO) : BaseObserver<PoseMotion, Any, Pose2d>() {

    init {
        state = initialPose
    }

    override fun getState(measurement: PoseMotion, lastSignal: Any, elapsedSeconds: Double): Pose2d {
