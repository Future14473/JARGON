...
class SegmentsMotionProfile private constructor(private val segments: List<Segment>) : MotionProfile {
    ...
    override val distance: Double = segments.last().state.x
    ...
    override fun stepper(): Stepper<Double, MotionState1d> = object :
        Stepper<Double, MotionState1d> {
        private var i = -1

        override fun stepTo(step: Double): MotionState1d = step.let { time ->
            if (i == -1) {
